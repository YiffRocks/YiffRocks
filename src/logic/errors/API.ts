...
export const PostErrors = {
	...
	MINIMUM_TAGS:                 new APIError(1203, `You must have at least ${Config.minPostTags} tags.`),
	MAXIMUM_TAGS:                 new APIError(1204, `You cannot have more than ${Config.maxPostTags} tags.`),
